...
sudo /sbin/iptables -t nat -A POSTROUTING -o p4p1 -j MASQUERADE
sudo /sbin/iptables -A FORWARD -i p4p1 -o wlan0 -m state --state RELATED,ESTABLISHED -j ACCEPT
sudo /sbin/iptables -A FORWARD -i wlan0 -o p4p1 -j ACCEPT
...
ifconfig p4p1:9 up
ip addr add 192.168.254.254/24 dev p4p1:9
